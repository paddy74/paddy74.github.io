...
3. Define [documentation governance](#handbook-governance) and processes for creating, updating, and managing documentation.
4. Follow the same change management workflows used for source code.
5. Be understandable, concise, current, accurate, and free of redundancy.
6. Provide strong version control; record the history and commentary around changes.
...
Formal policies, standards, and procedures are controlled documents. This differs from uncontrolled documents: informal guides, certain pages or sections, blog posts, templates, etc.

For more information, see the [Controlled Document Procedure](./controlled-docs.md) page.

All readers are welcome and encouraged to submit a change request or issue to create or suggest changes to controlled documents at any time.
