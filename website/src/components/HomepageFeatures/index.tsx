...
import DocuMountainSvg from "@site/static/img/undraw_docusaurus_mountain.svg";
import DocuTreeSvg from "@site/static/img/undraw_docusaurus_tree.svg";
import DocuReactSvg from "@site/static/img/undraw_docusaurus_react.svg";
